<%-- 
    Document   : taxBenifitCalculation
    Created on : 1 Sep, 2016, 5:24:01 PM
    Author     : ADMIN
--%>
                        ...
                        <ul class="account-nav-dropdown">
                            <li>
                                ...
                                <div class="account-nav-dropdown__container">
                                    <ul>
                                        <li><a href="SignOut">Sign out <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
...
<main class="site grid">
    ...
    <h1 data-heading="h1">Predicted future value is :<s:property  value="predictedValue" /></h1>

    <s:set var="upfrontInvestment"><s:property  value="upfrontInvestment" /></s:set>
    <s:set var="sip"><s:property  value="sip" /></s:set>
    <s:set var="years"><s:property  value="years" /></s:set>
    <s:set var="riskCategory"><s:property  value="riskCategory" /></s:set>
    <s:set var="plan"><s:property  value="plan" /></s:set>
    <s:set var="predictedValue"><s:property  value="predictedValue" /></s:set>
    <s:form action="Summary.jsp">
