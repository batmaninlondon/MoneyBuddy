...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="css/mbchart.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <script src="assets/js/custom.form.wizard.js"></script>
        <script src="assets/js/vendor/jquery.smartWizard.js"></script>
