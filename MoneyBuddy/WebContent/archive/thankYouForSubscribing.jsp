...
<!--         <div class="top-bar">
    ...
    <section id="thankYouForRegistration">
	
	<div class="row" style="margin-top:50px;">
		<div class="center">
			<!-- <h2 style="font-family:Aparajita;font-size:35px;"><b>THANKS</b></h2> -->
		</div>
	</div>	
	
	<div class="row" style="margin-top:-60px;">
		<div class="center">
			<h2 style="font-family:Aparajita;font-size:35px;"><b>Thank You for subscribing with MoneyBuddy</b></h2>
		</div>
	</div>
	<div class="row" style="margin-top:-60px;">
		<div class="center">
			<!-- <h2 style="font-family:Aparajita;font-size:30px;"><b>Kindly check your mail box, and click the verification link to activate your account.</b></h2> -->
		</div>
	</div>
