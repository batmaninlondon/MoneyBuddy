...
<div id="dialog" title="Basic dialog">
  <p>This is the default dialog SAIL WADHWANI which is useful for displaying information. The dialog window can be moved, resized and closed with the 'x' icon.</p>
</div>
