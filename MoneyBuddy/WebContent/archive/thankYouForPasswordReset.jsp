...
<!--         <div class="top-bar">
    ...
    <section id="thankYouForPasswordReset">
	...
	<div class="row" style="margin-top:-60px;">
		<div class="center">
			<h2 style="font-family:Aparajita;font-size:35px;"><b>We've sent you an email with instructions on how to reset your password.</b></h2>
		</div>
	</div>		
