				...
				<tbody class="table-body" >
					...
					<%-- <s:iterator value="#session.productList" var="productListElement"> --%>
						...
						<tr>
						    ...
						    <%-- <td class="center"><s:property value="#productListElement.value"/></td> --%>
						    <td class="center" style="padding:0px;">
						    <button type="button" id="submit-button-1" class="btn btn-info btn-lg submit-button-1 sharp raised " style="border-radius:3px;margin:5px;padding:8px 25px 8px 25px;"onClick="">Pay Now</button>
						    </td>
						</tr>
					<%-- </s:iterator>  --%>
