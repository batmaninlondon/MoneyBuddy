<%-- 
    ...
    Created on : 23 Aug, 2016, 11:25:59 PM
    Author     : ADMIN
--%>
...
<head>
    ...
    <title>MoneyBuddy - Reset Password - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Set a new password</h1>
    </div>
</div>
<!-- end of heading -->
...
<div class="change-password">
    ...
    <div class="grid">
<!--<form action="/Auth/ResetPassword/wadhwani.mail100%40gmail.com/0f79e463-4ab6-476b-99ce-193d0f6ffa62" method="post" novalidate=""><input name="__RequestVerificationToken" type="hidden" value="bZWquHJnXXPSELzxf9tqyOCV0YznHm6ZoLMrv2JdXtQB264Cx3kuicTgvPJr8FWcIApM5B32wkFD3DyvuDemWMrLqJ01" /><input id="CustomerID" name="CustomerID" type="hidden" value="907a2d62-d567-e611-80cc-44a8424af144" /><input name="__CustomerIDToken" type="hidden" value="yaZVLU8w4TuIIcmFTvqTE09EMaU+Naz6w0JVurccdoelLdZisPhPh6pEmBoHy/jvc+jq8opDubhCbYOVtAeXjKNHeSRuOk7hH2hrEZku6HogfZ0Ojg4a0mPwT7xI3s2J++D8HEmLXXR1MNTqN7NsCUa378Q=" /><input id="EmailAddress" name="EmailAddress" type="hidden" value="wadhwani.mail100@gmail.com" /><input name="__EmailAddressToken" type="hidden" value="qbnW0NwAvH2VaFoQlwZ36sksN9SUfHINMdqeZzJKBvZjjn5EDQWuvLnAhIWKURqnRe60H5Pi2QroEkGVq/csdzTAkCNQDvWrW+i9ZUtS0hgiAUyZH79g+D8koGM/mN/Bu8NQ1g==" />            <div class="form form--inline" data-form="">

                <label class="form-field">
                    <span class="label--field"><label for="Password">New password</label></span>
                    <input data-val="true" data-val-customregex="Password must be between 8 and 20 characters, and must contain at least one number, and one upper case character." data-val-customregex-regex="^(?=.*[A-Z])(?=.*[0-9]).{8,20}$" data-val-length="Your new password must be a maximum length of 20 characters." data-val-length-max="20" data-val-required="Please enter your new password." id="Password" name="Password" type="password" />
                    <span class="field-validation-valid" data-valmsg-for="Password" data-valmsg-replace="true"></span>
                </label>

                <label class="form-field">
                    <span class="label--field"><label for="ConfirmPassword">Confirm password</label></span>
                    <input data-val="true" data-val-equalto="The passwords do not match." data-val-equalto-other="*.Password" data-val-required="Please confirm your new password." id="ConfirmPassword" name="ConfirmPassword" type="password" />
                    <span class="field-validation-valid" data-valmsg-for="ConfirmPassword" data-valmsg-replace="true"></span>
                </label>


                <button type="submit" data-button="bright arrow">
                    <span>Change password <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
                </button>
            </div>
</form>-->
<%
    ...
    System.out.println("value of hash : "+hash);

    String email = (String)request.getParameter("email");
    System.out.println("value of hash email: "+email);
...
%>
    ...
    <s:form action="resetPassword">
                ...
                <s:password label="New Password" key="newPassword" size="90" width="1000" />
                <s:password label="Confirm Password" key="confirmPassword" size="90" width="1000" />
                <br/><br/><br/>
