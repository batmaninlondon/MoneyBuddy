...
<head>
    ...
    <title>MoneyBuddy - Kyc Already Done - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Please take time to answer few question</h1>
    </div>
</div>
<!-- end of heading -->
...
<div id="sanity-check-wrapper">
    ...
    <s:form action="KycNotDone">
        <h2>
        <s:radio
            label="Gender"
            name="answer1"
            list="#{'1':'Female','2':'Male'}"
            value="1"
        />
        ...
        <s:radio
            label="Date of birth"
            name="answer3"
            list="#{'1':'Calender needs to be inserted here'}"
            value="1"
        />
        ...
        <s:radio
            ...
            name="answer4"
            list="#{'1':'Resident Indian','2':'Non Resident Indian-NRI','3':'foreign national0'}"
            value="1"
        />
        ...
        <s:radio
            label="Annual Income"
            name="answer5"
            list="#{'1':'below 1 Lakh','2':'1-5 Lakh','3':'5-10 Lakh','4':'10-25 Lakh','5':'above 25 Lakh'}"
            value="1"
        />
        ...
        <s:radio
            label="Occupation"
            name="answer6"
            list="#{'1':'Pvt. Sector service','2':'Govt sector service','3':'Business/ self employed','4':'retired','5':'student','6':'housewife'}"
            value="1"
        />

        <s:radio
            label="Are you politacally exposed person"
            name="answer7"
            list="#{'1':'No','2':'Yes','3':'related to politacallty exposed person'}"
            value="1"
        />
        </h2>
        ...
        <h1>You can download the form from here .</h1>
</div>
</div>
<!-- end of content-wide -->
