<%-- 
    Document   : ThankYouForRegistration
...
<div class="sign-in">
    <div class="grid">
        <div id="ForgottenPasswordWrapper">
            <h1>THANKS</h1>
            <p>We've sent you a verification mail.</p><br/>
            <p>Kindly check your mail box, and click the verification link to activate your account</p>
        </div>
    </div>
</div>
</div>
