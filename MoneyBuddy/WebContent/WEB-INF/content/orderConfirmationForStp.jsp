...
<body style="background: url(img/1920x1080/01.jpg) 50% 0 no-repeat fixed;">
   <div class="container ">
	...
	<s:form  action="stpAction" method="post" name="formStp">
	...
	<div class="row g-margin-t-o-20--xs">
		...
		<div class="col-md-2">
			<button type="button"  id="pay-now-button" class="text-center disabled btn btn-home g-color--white g-margin-t-15--xs " onClick="callStpAction();" >Continue</button>
		</div>
		<div class="col-md-5">
		</div>
	</div>
