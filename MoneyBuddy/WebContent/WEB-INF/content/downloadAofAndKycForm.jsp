   ...
   <header id="header">
	...
	<div class="row" >
		...
		<div class="col-md-12 center" style="margin-top:-50px;">
			<h2 style="font-family:Aparajita;font-size:30px;"><b>Please download the Kyc and Account Opening form.</b></h2>
		</div>
		<!-- <div class="col-md-3"></div> -->
	</div>	
		...
		<div  class="row" style="padding-left:70px;padding-right:70px;">
			<div class="col-md-5"></div>
			<div class ="col-md-5">
				<button type="button" class="btn btn-primary readmore submit-button-1" onClick="window.open('${pageContext.request.contextPath}/assets/AofForms/<s:property value="aofForm"/>')">Download Account Opening Form</button>
