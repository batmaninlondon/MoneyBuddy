                        ...
                        <div class="s-header-v2__navbar-col s-header-v2__navbar-col--right">
                            ...
                            <div class="collapse navbar-collapse s-header-v2__navbar-collapse" id="nav-collapse">
                                <ul class="s-header-v2__nav">
                                    ...
                                    <li class="s-header-v2__nav-item"><a href="nsavetax" class="s-header-v2__nav-link">Save Tax</a></li>
                                    ...
                                    <li class="s-header-v2__nav-item"><a href="nfaq" class="s-header-v2__nav-link">FAQs</a></li>
                                    <li class="s-header-v2__nav-item"><a href="ncontact" class="s-header-v2__nav-link">Contact Us</a></li>
                                   
							         	<%  if(session.getAttribute("customerId") == null)
										 	{   %> 
													<li class="s-header-v2__nav-item"><a href="nlogin" class="s-header-v2__nav-link">Sign in</a></li>
													<li class="s-header-v2__nav-item"><a href="nlogin" class="s-header-v2__nav-link">Sign up</a></li>
										<%	} else 
										 	{	%>
                                    				...
                                    				<li class="s-header-v2__nav-item"><a href="nlogin" class="s-header-v2__nav-link">Log Out</a></li>
