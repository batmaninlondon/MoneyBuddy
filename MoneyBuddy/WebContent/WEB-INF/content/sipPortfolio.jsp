...
<%@taglib prefix="s" uri="/struts-tags" %>
                	...
                	<div class="row" >
	             		<div class="col-md-12 col-xs-12 g-full-width--xs g-margin-b-10--xs g-bg-color--white g-box-shadow__dark-lightest-v4" >
							...
							<s:if test="sipDataModel.size == 0">  
								<p><b>No ongoing SIPs, start one today</b></p>
							</s:if>
							<s:else>
				<s:iterator value="sipDataModel" var="sipDataModelElement" status="ctr">
								...
								<figure class="snip1419 g-height-130--xs  " style="width:100%"   >
				  					...
				  					<!-- <figcaption > -->
				    					<article class=" panel panel-info panel-heading  g-height-60--xs " >
				    						...
				    						<s:property value="#sipDataModelElement.schemeName"/>
				    						&nbsp;&nbsp;&nbsp;&nbsp;
											
				    						</p>
				    						
											 <p class="g-color--black g-line-height--lg  g-font-size-10--xs g-font-size-12--lg" >
											 	<b>Folio Number:</b> <s:property value="#sipDataModelElement.folioNumber"/>
										 	</p>
									        ...
									        <table  class="table-borderless  " cellspacing="0" width="100%">
										        <thead>
										            <tr class="g-bg-color--white g-font-family--playfair text-center " >
										                <th class="text-center" ><span class=" g-font-size-12--xs g-font-size-16--md">Fund Category</span></th>
										         ...
										         <tbody>
										            <tr class="g-font-family--playfair g-bg-color--white g-font-size-12--xs g-font-size-16--lg text-center" >
										                <td class="text-center " ><span class=" ">
									                		<s:property value="#sipDataModelElement.schemeType"/>
									                		</span></td>
														<td class="text-center" ><span >
															<fmt:formatNumber type="number" maxFractionDigits="2">
																<s:property value="#sipDataModelElement.investedAmount"/>
															</fmt:formatNumber>
														</span></td>
														<td class="text-center" ><span >
															<s:property value="#sipDataModelElement.nextSipDate"/>
														</span></td>
										            </tr>
										        </tbody>
										    </table>
