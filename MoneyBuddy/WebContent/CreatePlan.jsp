<%-- 
    Document   : CreatePlan
    Created on : 26 Aug, 2016, 12:20:03 PM
...
<head>
    ...
    <title>MoneyBuddy - Create a plan - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<header class="site-header">
    ...
    <main class="site grid">
        <h1 data-heading="h1 center">
            What kind of plan are you looking for?
        </h1>

        <div class="isa-choice">
            <div class="isa-choice__choices">
                <ul>
                    <li class="option">
                        <a href="MutualFundPlan.jsp?plan=wealthPlan">
                            <div>
                                &nbsp;Looking<br />&nbsp;for Wealth<br/>&nbsp;  Creation
                                <svg role="img" class="icon--arrow-small">
                    ...
                    <li class="option">
                        <a href="MutualFundPlan.jsp?plan=saveTax">
                            <div>
                                &nbsp;Looking<br />&nbsp;to Save Tax&nbsp;<br />&nbsp;&nbsp;u/s 80C
                                <svg role="img" class="icon--arrow-small">
                                    <use xlink:href="#arrow-small"></use>
                                </svg>
                            </div>
            ...
            <a class="isa-choice__more" data-button="transparent icon--left" href="javascript:void(0);" data-modal="MoreInfo">
                <svg class="icon--info" role="img"><use xlink:href="#info"></use></svg> More information about ISAs
            </a>
        </div>
    </main>
    <!-- /SITE CONTENT -->
    ...
    <!-- end of modal-dialog -->
        ...
        <div id="MoreInfo" class="modal-dialog">
            <div>
                <a class="icon--circle icon--dark close" href="#close" title="Close"><svg class="icon--close" role="img"><use xlink:href="#close"></use></svg></a>
                <h3 data-heading="h3">Is an ISA for me?</h3>
                <p>Individual Savings Accounts (known as ISAs) hold the same investments as a Regular Plan, but you keep more of the returns for yourself as they don?t get taxed.</p>
                <p>You can open an ISA with Wealthify if you:</p>
                <ul>
                    <li>Are over 18</li>
                    <li>Live in the UK</li>
                    <li>Have not opened an Investment ISA since 6th April 2016</li>
                </ul>
                <p>The Government currently lets you put up to &#163;15,240 a year in a Cash ISA or Investment ISA, or you can split your allowance between the two. Please note, Wealthify only offers Investment ISAs. </p>
            </div>
        </div>
        <!-- end of modal-dialog -->
