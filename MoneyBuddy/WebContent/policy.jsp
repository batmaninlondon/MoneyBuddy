                    ...
                    <div  id="contents" class="row" style="padding: 0px;" >
	              		<div class="col-md-12 col-xs-12 g-full-width--xs g-margin-b-40--xs g-margin-b-10--lg  g-bg-color--white g-box-shadow__dark-lightest-v4" >
	              			<div class="g-text-center--xs g-margin-b-40--xs">
	                    		<h3 class="g-font-size-20--xs g-font-size-32--md g-font-family--playfair g-letter-spacing--1 g-color--dark text-left font-weight-bold   g-margin-t-20--xs"><b>Our Privacy Policy</b></h3>
	                    		<div class="g-color--text g-font-family--playfair g-letter-spacing--1" style=" text-align: justify; height : 500px; overflow : auto;" >
	                    			<p>
	                    			This privacy policy sets out how moneybuddy.in and MoneyBuddy Technology Pvt. Ltd. uses and protects any information that you share when you use this website. We value the trust you place in us. That&#39; why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices.
									</p>
									<p>
									Note:
									</p>
									<p>
										Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically. This policy is effective from March 01, 2018.
									</p>
									<p>
