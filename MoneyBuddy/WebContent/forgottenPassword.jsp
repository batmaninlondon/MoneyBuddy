<%-- 
    ...
    Created on : 12 Aug, 2016, 12:47:51 PM
    Author     : ADMIN
--%>
...
<head>
    <title>MoneyBuddy - Forgotten Password - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Forgotten Password</h1>
    </div>
</div>
<!-- end of heading -->
...
<div class="sign-in">
    <div class="grid">
        <div id="ForgottenPasswordWrapper">
            <!--<form action="/Auth/ForgottenPasswordForm?Length=4" data-ajax="true" data-ajax-complete="form.HandleAjaxFormComplete(xhr, status, &#39;#form-forgotten-password&#39;)" data-ajax-mode="replace" data-ajax-update="#ForgottenPasswordWrapper" id="form-forgotten-password" method="post" novalidate=""><input name="__RequestVerificationToken" type="hidden" value="KuZMQCIx3NYRHGhs6uMMKUyr0TjHHqmRwxVKontv0lJTXzfVEaC8HPb6Cv2r15fiNHIhX3KBcqwUaBBGJ27qqGnzmS41" />
                <div class="form form--inline" data-form="">

        <label class="form-field">
            <span class="label--field"><label for="EmailAddress">Email address</label></span>
            <input class="text-box single-line" data-val="true" data-val-customregex="Please enter a valid email address." data-val-customregex-regex="^[\w-\.]+@([\w-]+\.)+[\w-]{2,6}$" data-val-length="The field Email address must be a string with a maximum length of 254." data-val-length-max="254" data-val-required="Please enter your email address." id="EmailAddress" name="EmailAddress" type="text" value="" />
            <span class="field-validation-valid" data-valmsg-for="EmailAddress" data-valmsg-replace="true"></span>
            <span class="field-validation-valid" data-valmsg-for="NoAccount" data-valmsg-replace="true"></span>
        </label>

        <button type="submit" data-button="bright arrow">
            <span>Submit <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
        </button>
    </div>
</form>
            -->
