<%-- 
    Document   : Summary
    Created on : 14 Sep, 2016, 11:36:47 AM
    Author     : ADMIN
--%>
...
<head>
    ...
    <title>MoneyBuddy - Your MoneyBuddy Plan Summary - MoneyBuddy.com</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="https://invest.wealthify.com/assets/css/style.min.css?v=1153532">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Your MoneyBuddy Plan Summary</h1>
    </div>
</div>
<!-- end of heading -->
    ...
    <div class="plan-summary">
        <div class="grid">
            <div class="plan-summary__item">
                <div class="plan-summary__label">Plan</div>
                <div class="plan-summary__val">My Plan</div>
            </div>
            <div class="plan-summary__item">
                <div class="plan-summary__label">Initial investment</div>
                <div class="plan-summary__val">Rs.<%=request.getParameter("upfrontInvestment")%></div>
            </div>
            <div class="plan-summary__item">
                <div class="plan-summary__label">Monthly payment</div>
                <div class="plan-summary__val">Rs.<%=request.getParameter("sip")%></div>
            </div>
            <div class="plan-summary__item">
                <div class="plan-summary__label">Timeframe</div>
                <div class="plan-summary__val"><%=request.getParameter("years")%> Years</div>
            </div>
            <div class="plan-summary__item">
                <div class="plan-summary__label">Investment style</div>
                <div class="plan-summary__val"><%=request.getParameter("riskCategory")%></div>
            </div>
            <div class="plan-summary__item">
                <div class="plan-summary__label">Save Tax</div>
                <div class="plan-summary__val">No</div>
            </div>
            <div class="plan-summary__edit">
                <a href="TaxBenifit.jsp">Edit Plan<div class="icon--circle icon--dark"><svg class="icon--edit" role="img"><use xlink:href="#edit"></use></svg></div></a>
                <!--<a href="javascript:void(0);" data-modal="savePlanModal" class="plan-actions__save">Save Plan<div class="icon--circle icon--dark"><svg class="icon--save" role="img"><use xlink:href="#save"></use></svg></div></a>-->
            </div>
        </div>
    </div>
    <!-- end of plan-summary -->
...
<input name="__RequestVerificationToken" type="hidden" value="eXWgNyFzJ3S2KhxVK1aDytYYnpakDI4I0AeCiaFZw0H4rUHSilsBOd49QGymO3cx4SCsLvp_oqIVN0Wen0GBjKBUnCI1" />
<input data-js="investment-style" data-val="true" data-val-number="The field Investment style must be a number." data-val-range="The field Investment style must be between 1 and 5." data-val-range-max="5" data-val-range-min="1" data-val-required="The Investment style field is required." id="InvestmentStyle_RiskValue" name="InvestmentStyle.RiskValue" type="hidden" value="4" />
<input data-js="initial-investment" data-val="true" data-val-number="The field InitialInvestment must be a number." data-val-range="Min £250" data-val-range-max="100000000" data-val-range-min="250" data-val-required="Enter a value" id="InitialInvestment" name="InitialInvestment" type="hidden" value="250" />

<div class="your-plan">
    <div class="grid">
        <div class="plan-breakdown">
            <div class="plan-breakdown__label">
                <div class="plan-breakdown__label-text">
                    Where we invest your money
                    <button type="button" class="tooltip icon--circle icon--dark" title="This chart gives an indication of how your plan would be invested today.
                            Over time, this mix will change to give you the best chance of achieving your goals.">
                        <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
                    </button>
                    <div class="icon--toggle icon--circle icon--dark" data-hide="tablet desktop" data-js="toggleBreakdown">
                        <svg role="img" class="icon--arrow-dropdown"><use xlink:href="#arrow-dropdown"></use></svg>
                    </div>
                </div>
            </div>
            <div class="plan-breakdown__content">
                <div class="plan-breakdown__dropdown">
                    <select name="select-investment-type" id="" class="plan-breakdown__select">
                ...
                <img src="displayChart?riskCategory=<%=request.getParameter("riskCategory")%>"/>
                <!-- 
                <div class="plan-breakdown__panes">
                    <div class="plan-breakdown__pane">
                        <div class="plan-breakdown__chart">
                            <canvas id="chart--investment" class="chart" width="275" height="275"></canvas>
                        </div>
                        <div class="plan-breakdown__legend legend--investment"></div>
                    </div>
                    <div class="plan-breakdown__pane">
                        <div class="plan-breakdown__chart">
                            <canvas id="chart--region" class="chart" width="275" height="275"></canvas>
                        </div>
                        <div class="plan-breakdown__legend legend--region"></div>
                    </div>
                    <div class="plan-breakdown__pane plan-breakdown__summary">
                        <ul class="plan-breakdown__list">
                            <li>We will invest your money in a variety of funds, in line with the mix shown in the ‘Investment Type’ chart.</li>
                            <li>A fund holds a collection of investments and is a more convenient and cheaper way to invest than buying hundreds of separate investments directly.</li>
                            <li>Normally, we use passive funds which track the market, rather than try to outperform it. This style of investing is most cost-effective and offers the best chance of good long term performance.</li>
                            <li>Our investment experts choose which funds to buy and when, and manage the mix of funds in your plan on an ongoing basis.</li>
                        </ul>
                    </div>
                </div>
                -->
        ...
        <!-- end of plan-breakdown -->

        <div class="your-plan__performance">
            <div class="your-plan__contribution">
                <div class="your-plan__label">
                    Total investment
                    <span>(Rs.<%=Double.parseDouble(request.getParameter("upfrontInvestment"))%> + <%=(Integer.parseInt(request.getParameter("years"))*12)%> months x Rs.<%=Double.parseDouble(request.getParameter("sip"))%>) </span>
                </div>
                <div class="your-plan__val">Rs.<%=Double.parseDouble(request.getParameter("upfrontInvestment"))+(Double.parseDouble(request.getParameter("sip"))*12*Double.parseDouble(request.getParameter("years")))%></div>
            </div>
            <div class="your-plan__fees">
                <div class="your-plan__label">
                    MoneyBuddy annual fee
                </div>
                <div class="your-plan__val">0.0%</div>
            </div>
            <!--
            <div class="your-plan__fees">
                <div class="your-plan__label">
                    Estimated monthly fee
                    <button type="button" class="tooltip icon--circle icon--dark" title="This is an estimate of your first month’s fee, including VAT.
                            Your actual fee will depend on the value of your investment at the time we calculate the fee, how much you add or withdraw, and whether you qualify for a Circle discount.">
                        <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
                    </button>
                </div>
                <div class="your-plan__val">&#163;0.15</div>
            </div>
            -->

            <!--
            <div class="your-plan__feeslabel">
                See our fees
                <div class="icon--toggle icon--circle icon--dark" data-js="toggleFees">
                    <svg role="img" class="icon--arrow-dropdown"><use xlink:href="#arrow-dropdown"></use></svg>
                </div>
            </div>
            -->
            <!--
            <div class="your-plan__feetable-wrapper">

    <table class="table your-plan__feetable">
        <tbody>
            <tr>
                <th>Account size</th>
                    <td class="">&#163;250</td>
            ...
            -->
            <div class="your-plan__expected">
                <div class="your-plan__label">
                    Predicted value
                    <button type="button" class="tooltip icon--circle icon--dark" title="The ‘predicted value’ is an indication of what your money could be worth at the end of the timeframe you selected.
                            To calculate this figure, we use ARC benchmark data, an industry-standard measure that gives us information on the past performance of hundreds of comparable private investment plans.
                            We use this data to help predict the most likely future value of your investments.
                            Naturally, figures are not guaranteed and predictions are never perfect, but this will give you a good idea of what your investment could be worth.">
                        <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
                    </button>
                </div>
                <div class="your-plan__val"><%=request.getParameter("predictedValue")%></div>
            </div>
            <div class="forecast-disclaimer">
                <svg role="img" class="icon--nb"><use xlink:href="#nb"></use></svg>
                <p>These forecasts are a guide only.<br />Your predicted value is not a guaranteed return.</p>
            </div>
        </div>
        <!-- enf of plan performance -->
    </div>
    <!-- end of grid -->
</div>
<!-- end of your plan -->
...
<div class="plan-bar">
    <div class="grid">
        <ul class="plan-steps">
            <li class="plan-steps__plan is-selected"><span>Plan</span></li>
            <li class="plan-steps__apply"><span>Apply</span></li>
            <li class="plan-steps__invest"><span>Invest</span></li>
        </ul>
        <div class="plan-actions">
            <a href="SanityCheck.jsp?predictedValue=<%=request.getParameter("predictedValue")%>&riskCategory=<%=request.getParameter("riskCategory")%>&plan=<%=request.getParameter("plan")%>&upfrontInvestment=<%=request.getParameter("upfrontInvestment")%>&sip=<%=request.getParameter("sip")%>&years=<%=request.getParameter("years")%>" class="plan-actions__apply" data-button="bright arrow">
                <span>
                    Continue <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg>
                </span>
            </a>
            <a href="RegularAccount" class="back-link">
                <svg role="img" class="icon--arrow-back.svg"><use xlink:href="#arrow-back"></use></svg> Back
            </a>
        </div>
    </div>
</div>
...
<!-- end of content-wide -->
    ...
    <div class="how-we-invest--funds">
        <div class="grid">
            <h2 data-heading="h2">We use funds from leading providers to build your plan</h2>
            <div class="how-we-invest--funds__list">
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/Vanguard.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/Aberdeen.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/Henderson.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/Fidelity.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/LegalAndGeneral.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/Blackrock.gif">
                    </span>
                </div>
                <div class="fund-holder">
                    <span class="fund-type">
                        <img class="fund-logo" src="https://invest.wealthify.com/assets/images/partner-logos/iShares.gif">
                    </span>
                </div>
            </div>
        </div>
...
<footer class="site-footer">
    <div class="grid">
        <ul class="social-nav">
            <li>
                <a href="https://www.facebook.com/Wealthify-734189690028131" class="social-nav__facebook" target="_blank">
            ...
            <li>
                <a href="https://twitter.com/wealthify_com" class="social-nav__twitter" target="_blank">
                    <div class="social-icon-wrapper">
            ...
            <li>
                <a href="https://www.linkedin.com/company/wealthify" class="social-nav__linkedin" target="_blank">
                    <div class="social-icon-wrapper">
            ...
            <ul class="footer-nav">
                <li><a href="/Register/ClientTerms" target="_blank">Terms &amp; Conditions</a></li>
                <li><a href="https://www.wealthify.com/privacy" target="_blank">Privacy Policy</a></li>
                <li><a href="https://www.wealthify.com/faq" target="_blank">FAQs</a></li>
                <li><a href="https://www.wealthify.com/help-centre">Help centre</a></li>
                <li><a href="https://www.wealthify.com/why-invest/fees" target="_blank">Our Fees</a></li>
            </ul>
        <div data-row="">
            ...
            <div class="footer__status-disclosure">
                Wealthify Limited is authorised and regulated by the Financial Conduct Authority (<a href="http://www.fca.org.uk/register" target="_blank">FCA No. 662530</a>) registered in England and Wales (Company No. 09034828) with a registered office at<br>
            ...
            <div class="footer__copyright">&copy; 2016 Wealthify Limited</div>
        </div>
    </div>
</footer>

    <!--
    <div id="savePlanModal" class="modal-dialog">
        <div>
            <a class="icon--circle icon--dark close" href="#close" title="Close"><svg class="icon--close" role="img"><use xlink:href="#close"></use></svg></a>
            <div id="SavePlan" class="save-plan">
<form action="/CreatePlan/SavePlan" data-ajax="true" data-ajax-method="POST" data-ajax-mode="replace" data-ajax-update="#SavePlan" id="form0" method="post" novalidate="">        <div class="save-plan-header">
            <h2 data-heading="h2">Save for later</h2>
            <p>We’ll email you a link to your Wealthify plan, so you can pick up where you left off.</p>
        </div>
        <div class="form form--inline" data-form="">
            <label class="form-field">
                <span class="label--field"><label for="FirstName">First name</label></span>
                <input class="text-box single-line" data-val="true" data-val-maxlength="Please enter up to 50 characters." data-val-maxlength-max="50" data-val-required="Please enter your  first name." id="FirstName" name="FirstName" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="FirstName" data-valmsg-replace="true"></span>
            </label>

            <label class="form-field">
                <span class="label--field"><label for="LastName">Last name</label></span>
                <input class="text-box single-line" data-val="true" data-val-maxlength="Please enter up to 50 characters." data-val-maxlength-max="50" data-val-required="Please enter your last name." id="LastName" name="LastName" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="LastName" data-valmsg-replace="true"></span>
            </label>

            <label class="form-field">
                <span class="label--field"><label for="EmailAddress">Email address</label></span>
                <input class="text-box single-line" data-val="true" data-val-customregex="Please enter a valid email address." data-val-customregex-regex="^[\w-\.]+@([\w-]+\.)+[\w-]{2,6}$" data-val-maxlength="Please enter up to 254 characters." data-val-maxlength-max="254" data-val-required="Please enter your email address." id="EmailAddress" name="EmailAddress" type="email" value="" />
                <span class="field-validation-valid" data-valmsg-for="EmailAddress" data-valmsg-replace="true"></span>
            </label>
        </div>
        <div class="save-plan-buttons">
            <a href="#close" class="back-link">
                <svg role="img" class="icon--arrow-back.svg"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-back"></use></svg> Cancel
            </a>
            <button class="save-plan-button" type="submit" data-button="bright arrow">
                <span>Save <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
            </button>
        </div>
</form></div>
        </div>
    ...
    <script>window.jQuery.ui || document.write('<script src="/assets/js/vendor/jquery-ui.min.js"><\/script>');</script>
    <script src="/assets/js/vendor/jquery.unobtrusive-ajax.min.js"></script>
