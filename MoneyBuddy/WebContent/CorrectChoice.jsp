<%-- 
    Document   : CorrectChoice
    Created on : 22 Aug, 2016, 11:41:38 AM
    Author     : ADMIN
--%>
...
<head>
    <title>MoneyBuddy - Thanks you - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Great Choice</h1>
    </div>
</div>
<!-- end of heading -->
...
<div class="sign-in">
    <div class="grid">
        <div id="ForgottenPasswordWrapper">
            <h1>Great</h1>
            <p>Your selection matched with our suggestion. Please click on continue button to proceed further.</p>
        </div>
    </div>
