<%-- 
    Document   : welcome
    Created on : 13 Jul, 2016, 12:21:07 PM
    Author     : Savita Wadhwai
--%>
...
<head>
    ...
    <title>MoneyBuddy - Dashboard - MoneyBuddy.com</title>
    <meta charset="utf-8">
    ...
    <![endif]-->
    <link rel="stylesheet" href="https://invest.wealthify.com/assets/css/style.min.css">
            ...
            <nav class="primary-nav">
                ...
                <div class="primary-nav__nav">
                        <ul class="primary-nav__main">
                            <li><a href="/Dashboard">Dashboard <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                            <li><a href="/Messages"><span class="primary-nav__notice" data-count style="display: none;"></span> Messages <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                            <li><a href="/Circle">Circles <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                            <li><a href="blog.jsp">Blog <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                            <li><a href="https://www.wealthify.com/help-centre">Help <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                        ...
                        <ul class="account-nav-dropdown">
                            <li>
                                ...
                                <div class="account-nav-dropdown__container">
                                    <ul>
                                        <li><a href="/Auth/Logoff">Sign out <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Dashboard</h1>

        <!-- dashboard header -->
        <div class="db-header">

                <div class="db-setup">
                    <p>You don't currently have any MoneyBuddy Plans. <a href="CreatePlan.jsp">Create your first Plan</a>.</p>
                </div>
                <!-- end db-setup -->
                        <!-- end db-actions -->
        </div>
...
<main class="content-wide">
    <div class="grid">
        <div class="db-main">
            ...
            <a href="CreatePlan.jsp" class="create-plan-button" data-button="bright">
                <span>Create a new plan <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
            </a>
        </div>
        <!-- end of db-main -->
        ...
        <div class="db-aside">
                ...
                <div class="circles">
        <div class="circles__canvas-container">
            <canvas id="circles-canvas" width="900" height="900" class="circles__canvas"></canvas>
        </div>
        <h3 data-heading="h3" class="circles__heading">Grow your Circle,<br />Shrink your fees.</h3>
        <p>Start a Circle, then invite family, friends, neighbours, or anyone you like. When they join and start a Plan, you'll all save on your fees. The bigger your Circle, the lower your fees - and everyone gets the same great discount!</p>

        <a href="javascript:void(0);" data-modal="CreateCircleModal" data-button="bright arrow full"><span>Start a circle <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span></a>
    </div>
    <!-- end of circles -->


<div class="blog-feed">
    <h3 data-heading="h3" class="blog-feed__main-heading">On the money</h3>
    <p>Investment, innovation, inspiration, and you.</p>

<div class="blog-feed__item">
    <a target="_blank" href="//www.wealthify.com/blog/which-of-tarantino-s-characters-make-the-best-investors" class="blog-feed__image"><img src="//www.wealthify.com/media/1006/asics-kill-bill-navy-orange-gl3-7.jpg" alt=""></a>
    <div class="blog-feed__content">
        <h4 data-heading="h2" class="blog-feed__heading"><a target="_blank" href="//www.wealthify.com/blog/which-of-tarantino-s-characters-make-the-best-investors">Which of Tarantino?s characters make the best investors?</a></h4>

    </div>
    <!-- end of feed-item -->
</div><div class="blog-feed__item">
    <a target="_blank" href="//www.wealthify.com/blog/property-funds" class="blog-feed__image"><img src="//www.wealthify.com/media/1046/160715_blog_property_med.jpg" alt=""></a>
    <div class="blog-feed__content">
        <h4 data-heading="h2" class="blog-feed__heading"><a target="_blank" href="//www.wealthify.com/blog/property-funds">Property funds</a></h4>

    </div>
    <!-- end of feed-item -->
</div><div class="blog-feed__item">
    <a target="_blank" href="//www.wealthify.com/blog/robo-how-did-we-fare-after-brexit" class="blog-feed__image"><img src="//www.wealthify.com/media/1043/brexit_istock_small.jpg" alt=""></a>
    <div class="blog-feed__content">
        <h4 data-heading="h2" class="blog-feed__heading"><a target="_blank" href="//www.wealthify.com/blog/robo-how-did-we-fare-after-brexit">Robo - how did we fare after Brexit?</a></h4>

    </div>
    <!-- end of feed-item -->
</div>
    <a target="_blank" href="https://www.wealthify.com/blog/" data-button="mid full" class="feed__button">All Articles <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a>
</div>
        </div>
        <!-- end of db-aside -->
    </div>
...
<footer class="site-footer">
    ...
    <div id="CreateCircleModal" class="modal-dialog">
    <div>
        <a class="icon--circle icon--dark close" href="#close" title="Close"><svg class="icon--close" role="img"><use xlink:href="#close"></use></svg></a>
        <form action="/Circle/Create" method="post" novalidate=""><input name="__RequestVerificationToken" type="hidden" value="l0BGSCOfXHR614jwYS4QYyZ2F0ijPttd4HZxK8zXZy87RjQNe3ZP_rKdYkRAxgPARpODrU05JWy8W0rydCpU-rn-OGWp8G9JoJco13rvn8NFprJd0" />    <h3 data-heading="h3">You made it, you name it...</h3>
    <p>As the creator of this Circle, you have the honour of naming it.</p>
    <div data-row>
        <div class="form form--inline" data-form="">
            <label class="form-field">
                <span class="label--field"><label for="Name">Circle name</label></span>
                <input class="text-box single-line" data-val="true" data-val-length="Your Circle name must be between 3 and 100 characters long." data-val-length-max="100" data-val-length-min="3" data-val-required="Please give your Circle a name." id="Name" name="Name" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
            </label>
        </div>

        <div class="text--center">
            <button type="submit" data-button="bright arrow">
                <span>Start Circle <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
            </button>
        </div>
    </div>
</form>
...
<div id="FeesModal" class="modal-dialog db-fees">
    <div>
        <a class="icon--circle icon--dark close" href="#close" title="Close"><svg class="icon--close" role="img"><use xlink:href="#close"></use></svg></a>
        <h2 data-heading="h2">Your fee</h2>
        <p>Fees are taken from your plan monthly and based on the value of your investment on the day they are calculated.</p>

            <table class="table db-fees__feetable table-responsive">
                <tbody>
                    <tr>
                        <th>Account size</th>
                            <td class="">&#163;250</td>
...
<!-- end of modal-dialog -->
    ...
    <script src="https://invest.wealthify.com/assets/js/scripts/create-js.min.js"></script>

        <script>
        olark('api.visitor.updateCustomFields', {
            customerID: '907a2d62-d567-e611-80cc-44a8424af144'
        });
    </script>
        ...
        if (typeof decibelInsight !== "undefined") {
            decibelInsight('updateUserId', 'WGY-656414');
        }
    </script>
