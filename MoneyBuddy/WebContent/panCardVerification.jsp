<%-- 
    Document   : panCardVerification
    Created on : 29 Aug, 2016, 10:40:48 AM
...
<head>
    ...
    <title>MoneyBuddy - Sorry - MoneyBuddy.com</title>
    <meta charset="utf-8">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">KYC Status Check</h1>
    </div>
</div>
<!-- end of heading -->
...
-->
            ...
            <s:form action="kycCheck">
                <!--<div class="form form--inline" data-form="">-->
                <s:textfield label="PAN card" key="panCard" size="90" width="1000" />
                <br/><br/><br/>
