...
<body background="images/backgroundImage5.jpg" onload="setType();">
	...
	<div class="row">
		...
		<div  id="invested-fund-list" class="col-md-6" style="margin-top:50px;padding-left:70px;padding-right:70px;">
		...
		<div  id="login-page" class="col-md-6" style="margin-top:250px;padding-left:70px;padding-right:70px;">
		...
		<div  id="pancard-verification" class="col-md-6" style="margin-top:250px;padding-left:70px;padding-right:70px;">
		...
		<div  id="payment-page" class="col-md-6" style="margin-top:150px;padding-left:70px;padding-right:70px;">	
...
<!-- 			<div class=""> -->
				...
				<div class="row">
					<div id="diamond-shape" class="col-md-12">
						...
						<p id="diamond-text-2" class="diamond-text-2">
							Invest Rs. <span id="totalInvestment"></span>
						</p>
						<p id="diamond-text-3" class="diamond-text-3">PREDICTED VALUE</p>
						<p id="diamond-text-4" class="diamond-text-4">
							Rs. <span id="predicted-value"><s:property value="#session.predictedValue" /></span>
						</p>
						<p id="diamond-text-5" class="diamond-text-5">
							after <span id="numberOfYears"></span> Years
						</p>
						<p id="diamond-text-6" class="diamond-text-6">Risk of
							underperformance</p>
						
						<p id="diamond-text-7" class="diamond-text-3">PREDICTED VALUE</p><br/>	
						<p id="diamond-text-8" class="diamond-text-8">AFTER 1 YEAR : Rs. <span id="predicted-value-list-1"><s:property value="#session.predictedValueList1" /></span>
						</p>

						<p id="diamond-text-9" class="diamond-text-9">AFTER 3 YEARS : Rs. <span id="predicted-value-list-2"><s:property value="#session.predictedValueList3" /></span>
						</p>

						<p id="diamond-text-10" class="diamond-text-10">AFTER 5 YEARS : Rs. <span id="predicted-value-list-3"><s:property value="#session.predictedValueList5" /></span>
						</p> 
...
<!-- 			</div> -->
	...
	<div id="button-1" class="row">
		<button type="button" id="submit-button-1" class="btn btn-info btn-lg submit-button-1 sharp raised" onClick="showPlan();">SEE YOUR PLAN</button>
	</div>
