						...
						$.getJSON('dashboardAction', {investmentTypeName : investmentTypeName}, function(jsonResponse) 
								{
									 ...
									 data1.addColumn('string', 'groupName');
									 data1.addColumn('string', 'productName');
									 data1.addColumn('string', 'productId');
									 data1.addColumn('string', 'totalQuantity');
									 data1.addColumn('string', 'pendingOrders');
									 data1.addColumn('string', 'availableToSell');
									 data1.addColumn('string', 'marketPrice');
									 data1.addColumn('string', 'buyingPrice');
									 data1.addColumn('string', 'marketValue');
									 data1.addColumn('string', 'gain');
									 
									 
									 $.each(jsonResponse.dashboardDataModel , function(i,dashboardData) 
											{

												 data1.addRow([dashboardData.groupName,
												               dashboardData.productName,
												               dashboardData.productId,
												               dashboardData.totalQuantity,
												               dashboardData.pendingOrders,
												               dashboardData.availableToSell,
												               dashboardData.marketPrice,
												               dashboardData.buyingPrice,
												               dashboardData.marketValue,
												               dashboardData.gain,
