		...
		<div class="col-md-8">
			...
			<div  class="col-md-6" >
			  	...
			  	<select class="form-control" id="tax-status" style="margin-top:-10px;">
			        ...
			        <option value="02">On Behalf Of Minor</option>
			        <option value="03">HUF</option>
			        <option value="04">Company</option>
			        <option value="05">AOP/BOI</option>
			        <option value="06">Partnership</option>
			        <option value="07">Body Corporate</option>
			        <option value="08">Trust</option>
			        <option value="09">Society</option>
			        <option value="21">NRI - Repatriable(NRE)</option>
			        <option value="22">Oversea Corporate Body</option>
			        <option value="23">Foreign Institutional Investor</option>
			        <option value="25">Oversea Corporate Body - Others</option>
			        <option value="31">Provident Fund - EPF</option>
			        <option value="32">Super Annuation Fund</option>
			        <option value="33">Gratuity Fund</option>
			        <option value="14">Bank/Finanacial Institution</option>
			        <option value="13">Sole Proprietorship</option>
			        <option value="34">Pension Fund</option>
			        <option value="24">NRI - Repatriable(NRO)</option>
			        <option value="26">NRI - Minor (NRE)</option>
			        <option value="27">NRI-HUF(NRO)</option>
			        <option value="10">NRI Through NRO A/c</option>
			        <option value="38">Global Development Network</option>
			        <option value="29">NRI-HUF(NRE)</option>
			        <option value="47">Limited Liability Partnership</option>
			        <option value="51">Public Limited Company</option>
			        <option value="52">Private Limited Company</option>
			        <option value="53">Unlisted Company</option>
			        <option value="61">OCI - Repatriation</option>
			        <option value="62">OCI - Non Repatriation</option>
			        <option value="70">Person of Indian Origin [PIO]</option>
			        <option value="74">Non-Government Organisation [NGO]</option>
