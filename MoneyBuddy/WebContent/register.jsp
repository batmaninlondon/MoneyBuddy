...
<head>
    <title>MoneyBuddy - Sign in - MoneyBuddy.com</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="//invest.wealthify.com/assets/css/vendor/basic.min.css" rel="stylesheet" />
    <link href="//invest.wealthify.com/assets/css/vendor/dropzone.min.css" rel="stylesheet" />
    <link href="//invest.wealthify.com/assets/css/vendor/jquery-ui.min.css" rel="stylesheet" />
    <link href="//invest.wealthify.com/assets/css/vendor/jquery-ui.theme.min.css" rel="stylesheet" />
    ...
    <script>window.Modernizr || document.write('<script src="//invest.wealthify.com/assets/js/vendor/modernizr.min.js"><\/script>');</script>
   <link rel="stylesheet" href="//invest.wealthify.com/assets/css/style.min.css">
...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Sign in to your account</h1>
    </div>
</div>
<!-- end of heading -->
...
<!--<form action="/Auth" method="post" novalidate=""><input name="__RequestVerificationToken" type="hidden" value="zClllmGy_gaY4C5-z7uS9gRRDrjET0B_QlH-7syXGK9PqhTWCHb-QbhUiYdpjHw-kg7pbxJgPGWdMwUgPpKp2VVHUyE1" />            <div class="form form--inline" data-form="">

                <label class="form-field">
                    <span class="label--field"><label for="Username">Email address</label></span>
                    <input class="text-box single-line" data-val="true" data-val-customregex="Please enter a valid email address." data-val-customregex-regex="^[\w-\.]+@([\w-]+\.)+[\w-]{2,6}$" data-val-length="The field Email address must be a string with a maximum length of 254." data-val-length-max="254" data-val-required="Please enter your email address." id="Username" name="Username" type="text" value="" />
                    <span class="field-validation-valid" data-valmsg-for="Username" data-valmsg-replace="true"></span>
                </label>

                <label class="form-field">
                    <span class="label--field"><label for="Password">Password</label></span>
                    <input data-val="true" data-val-length="The field Password must be a string with a maximum length of 20." data-val-length-max="20" data-val-required="Please enter your password." id="Password" name="Password" type="password" />
                    <span class="field-validation-valid" data-valmsg-for="Password" data-valmsg-replace="true"></span>
                    <span class="field-validation-valid" data-valmsg-for="IncorrectPassword" data-valmsg-replace="true"></span>
                </label>

                <button type="submit" data-button="bright arrow">
                    <span>Sign in <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></span>
                </button>
...
-->
        ...
        <s:form action="register" class="form-field" >
            <s:textfield label="First Name" key="firstName" size="70"/>
            <s:textfield label="Last Name" key="lastName" size="70"/>
            <s:textfield label="Email" key="email"/>
            <s:password label="Password" key="password" />

            <s:password label="Confirm Rassword" key="confirmPassword" />

            <s:textfield label="Contact Number" key="mobile" maxLength="10" />

            <!--<s:submit data-button="bright arrow" align="left" type="img" src="/MoneyBuddyImages/assests/images/submitButton.jpg" />-->
            ...
            <s:submit />
                ...
                <br/>
                <s:a href="forgottenPassword.jsp">Forgotten Password</s:a>
    </div>
</div>
</div>
<!-- end of content-wide -->
...
-->
    ...
    <script>window.jQuery || document.write('<script src="//invest.wealthify.com/assets/js/vendor/jquery-1.11.1.js"><\/script>')</script>
    <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script>
    <script>window.jQuery.ui || document.write('<script src="//invest.wealthify.com/assets/js/vendor/jquery-ui.min.js"><\/script>');</script>
    <script src="//invest.wealthify.com/assets/js/vendor/jquery.unobtrusive-ajax.min.js"></script>
    <script src="//invest.wealthify.com/assets/js/vendor/jquery.validate.min.js"></script>
    <script src="//invest.wealthify.com/assets/js/vendor/jquery.validate.unobtrusive.min.js"></script>
    <script src="//invest.wealthify.com/assets/js/vendor/moment.min.js"></script>
    <script src="//invest.wealthify.com/assets/js/vendor/jquery.smoothState.min.js"></script>
    <script src="//invest.wealthify.com/assets/js/scripts.min.js"></script>
    ...
    <script>
        olark('api.visitor.updateCustomFields', {
            sessionID: 'd5ec9810-eb61-e611-80cc-44a8424af144'
        });
    </script>
