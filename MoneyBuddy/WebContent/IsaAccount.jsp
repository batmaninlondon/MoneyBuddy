...
<head>
	...
	<link rel="stylesheet" href="../MoneyBuddyCSS.css">
    ...
    <a href="index.jsp" class="site-header__logo">
            ...
            <div class="primary-nav__nav">
                    <ul class="primary-nav__main">
                        ...
                        <li><a href="isa.jsp">Save Tax <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg></a></li>
...
<form action="/CreatePlan/IsaAccount" method="post" novalidate=""><input name="__RequestVerificationToken" type="hidden" value="ncMdoyC2-ERi6Qy2O1iOPy6m6QusTf-s56nQ6F7vhEDIT2EV5E-w9g6r8_yKn7CIzpUlw_sFBH7Q78Ddu4dys4xUQDuF_yomRohFFJ7f8snLcS8o0" />        <div class="invest-tool invest-tool-isa" data-row>
            <div class="invest-options">
                <input data-js="account-type" data-val="true" data-val-required="The AccountType field is required." id="AccountType" name="AccountType" type="hidden" value="InvestmentISA" />

<div class="invest-option invest-goal">
    <div class="invest-option__label" data-js-toggle="invest-goals">
            <span>Do you have a goal in mind?</span>
        <button type="button" class="icon--toggle icon--circle">
            <span class="rotate">
                <svg role="img" class="icon--arrow-dropdown"><use xlink:href="#arrow-dropdown"></use></svg>
            </span>
        </button>
    </div>
    <div class="invest-goal__goal">
        <div class="invest-goal__goal-label"></div>
    </div>
    <div class="invest-goals">
        <ul class="invest-goals__list">
                <li class="invest-goals__goal ">Rainy Day</li>
                <li class="invest-goals__goal ">Retirement</li>
                <li class="invest-goals__goal ">Wedding</li>
                <li class="invest-goals__goal ">New House</li>
                <li class="invest-goals__goal ">Uni Fees</li>
                <li class="invest-goals__goal ">Dream Holiday</li>
        </ul>
        <div class="invest-goals__controls">
            <button type="button" data-button="text" class="invest-goals__add">
                Create Goal <div class="icon--circle icon--no-border"><svg role="img" class="icon--add"><use xlink:href="#add"></use></svg></div>
            </button>
            <div class="invest-goals__form">
                <input type="text" class="invest-goals__add-input" maxlength="25" placeholder="Enter your goal">
                <button type="button" data-button="text-icon" class="icon--circle">
                    <svg role="img" class="icon--add"><use xlink:href="#add"></use></svg>
                </button>
            </div>
        </div>
    </div>
    ...
    <input data-js="invest-goal" id="SavingFor" name="SavingFor" type="hidden" value="" />
</div>
<!-- end invest-goal -->
                <div class="invest-option invest-option--amount" data-js="slider__initial">
    <div class="invest-option__label">
            <span>How much do you want to invest upfront?</span>
        <button type="button" class="tooltip icon--circle icon--no-border icon--teal" title="You can get started with just &#163;250.">
            <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
        </button>
    </div>
    <div class="slider">
        <div class="slider-value">
            <div class="slider-value__prefix">&pound;</div>
            <input class="slider-value__input" data-val="true" data-val-number="The field InitialInvestment must be a number." data-val-range="Min £250" data-val-range-max="100000000" data-val-range-min="250" data-val-required="Enter a value" id="InitialInvestment" name="InitialInvestment" pattern="[0-9]*" type="text" value="250" />
            <div class="icon--circle icon--light"><svg class="icon--edit" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#edit"></use></svg></div>
            <span class="field-validation-valid" data-valmsg-for="InitialInvestment" data-valmsg-replace="true"></span>
        </div>
        <div class="slider__wrapper">
            <button type="button" class="slider__button--less icon--circle">
                <svg role="img" class="icon--less"><use xlink:href="#less"></use></svg>
            </button>
            <button type="button" class="slider__button--more icon--circle">
                <svg role="img" class="icon--add"><use xlink:href="#add"></use></svg>
            </button>
...
<!-- end of invest-option -->
                <div class="invest-option invest-option--monthly" data-js="slider__monthly">
    <div class="invest-option__label">
            <span>How much do you want to invest monthly?</span>
        <button type="button" class="tooltip icon--circle icon--no-border icon--teal" title="Set up an optional Direct Debit from £20 a month.">
            <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
        </button>
    </div>
    <div class="slider">
        <div class="slider-value">
            <div class="slider-value__prefix">&pound;</div>
            <input class="slider-value__input" data-val="true" data-val-customrange="Min £20" data-val-customrange-allowzero="True" data-val-customrange-maximum="100000000" data-val-customrange-minimum="20" data-val-number="The field MonthlyTopUp must be a number." data-val-required="Enter a value" id="MonthlyTopUp" name="MonthlyTopUp" pattern="[0-9]*" type="text" value="0" />
            <div class="icon--circle icon--light"><svg class="icon--edit" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#edit"></use></svg></div>
            <span class="field-validation-valid" data-valmsg-for="MonthlyTopUp" data-valmsg-replace="true"></span>
        </div>
        <div class="slider__wrapper">
            <button type="button" class="slider__button--less icon--circle">
                <svg role="img" class="icon--less"><use xlink:href="#less"></use></svg>
...
<!-- end of invest-option -->
                <div class="invest-option invest-option--duration" data-js="slider__duration">
    <div class="invest-option__label">
            <span>How long do you expect to invest for?</span>
        <button type="button" class="tooltip icon--circle icon--no-border icon--teal" title="You can withdraw your money at any time, but the longer you leave it, the more chance it has to grow.">
            <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
        </button>
    </div>
    <div class="slider">
        <div class="slider-value">
            <div class="slider-value__prefix">&pound;</div>
            <input class="slider-value__input" data-val="true" data-val-number="The field TimeHorizon must be a number." data-val-range="Min 2, Max 40 years" data-val-range-max="40" data-val-range-min="2" data-val-required="Enter a value" id="TimeHorizon" name="TimeHorizon" pattern="[0-9]*" type="text" value="10" />
            <div class="slider-value__postfix">Years</div>
            <div class="icon--circle icon--light"><svg class="icon--edit" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#edit"></use></svg></div>
            <span class="field-validation-valid" data-valmsg-for="TimeHorizon" data-valmsg-replace="true"></span>
        </div>
        <div class="slider__wrapper">
            <button type="button" class="slider__button--less icon--circle">
                <svg role="img" class="icon--less"><use xlink:href="#less"></use></svg>
            ...
            <div class="slider__slide" data-increment="1"></div>
        </div>
    </div>
</div>
<!-- end of invest-option -->
...
<div class="invest-option invest-option__style">
    <div class="invest-option__label">
        What's your investment style?
    </div>
    <div class="investment-style">
        <div class="investment-style__wrapper">
            <div class="investment-style__pre-label">Cautious</div>
            <div class="investment-style__post-label">Adventurous</div>
            <ul class="investment-style__levels">
                <li class="investment-style__level  " title=""><div class="investment-style__label">1</div></li>
                <li class="investment-style__level  " title=""><div class="investment-style__label">2</div></li>
                <li class="investment-style__level  " title=""><div class="investment-style__label">3</div></li>
                <li class="investment-style__level  " title=""><div class="investment-style__label">4</div></li>
                <li class="investment-style__level  " title=""><div class="investment-style__label">5</div></li>
            </ul>
        </div>
        <ul class="investment-style__desc">
            <li><strong>Cautious</strong> <br />I want to invest with the least possible risk.</li>
            <li><strong>Tentative</strong> <br />I?m comfortable with a little risk in pursuit of growth.</li>
            <li><strong>Confident</strong> <br />I?ll take some risks in pursuit of better growth.</li>
            <li><strong>Ambitious</strong> <br />I?ll take risks in pursuit of high growth.</li>
            <li><strong>Adventurous</strong> <br />I?ll take big risks in pursuit of the highest growth.</li>
        </ul>
    </div>
    <!-- hidden input to store value -->
    <input data-js="invest-style" data-val="true" data-val-number="The field Investment style must be a number." data-val-range="The field Investment style must be between 1 and 5." data-val-range-max="5" data-val-range-min="1" data-val-required="The Investment style field is required." id="InvestmentStyle_RiskValue" name="InvestmentStyle.RiskValue" type="hidden" value="" />
    <input data-js="minimum-invest-style" data-val="true" data-val-number="The field MinimumInvestmentStyleAllowed must be a number." id="InvestmentStyle_MinimumInvestmentStyleAllowed" name="InvestmentStyle.MinimumInvestmentStyleAllowed" type="hidden" value="" />
    <input data-js="maximum-invest-style" data-val="true" data-val-number="The field MaximumInvestmentStyleAllowed must be a number." id="InvestmentStyle_MaximumInvestmentStyleAllowed" name="InvestmentStyle.MaximumInvestmentStyleAllowed" type="hidden" value="" />
</div>
<!-- end of invest-option -->
            </div>
            <!-- end of invest-options -->

            <div class="growth-estimate ">
    <div class="growth-estimate__main">
        <div class="growth-estimate__diamond" data-state="0">
            <div class="dots"></div>
            <div class="active-state"></div>
            <div class="initial-state"></div>
        </div>
        <!-- placeholder content -->
        <div class="growth-estimate__placeholder">
            <p>Use the sliders and select an investment style to calculate how much your investment could make.</p>
        </div>
        <!-- end of placeholder content -->
        <!-- placeholder content -->
        <div class="growth-estimate__isa">
            <p>
                Your selections will exceed your annual ISA limit of £15,240.<br />Adjust the sliders or<br />
                <a href="/CreatePlan/RegularAccount" data-js="no-ISA">don't invest as an ISA</a>
            </p>
        </div>
        <!-- end of placeholder content -->
        <!-- estimate content -->
        <div class="growth-estimate__content">
            <div class="growth-estimate__contribution">
                Invest <div class="growth-estimate__value"><span class="value"></span></div>
            </div>
            <div class="growth-estimate__expected">
                <div class="growth-estimate__label">
                    Predicted value
                    <button type="button" class="tooltip icon--circle icon--white"
                            title="The 'predicted value' is an indication of what your money could be worth at the end of the timeframe you selected.
                ...
                <div class="growth-estimate__value">
                    <span class="value"></span>
                </div>
                <div class="growth-estimate__term">after <span class="value"></span> years</div>
            </div>
            <div class="growth-estimate__others">
                <p class="risk-level--label">
                    Risk of under&shy;performance
                    <button type="button" class="tooltip icon--circle icon--white"
                            title="This shows the risk of your plan returning less than the predicted value. Increasing your timescale or choosing a lower-risk investment style should reduce the chance of your plan underperforming, but every investment contains some risk.">
                        <svg role="img" class="icon--info"><use xlink:href="#info"></use></svg>
                    </button>
                </p>
                <div class="risk-level rl--1">
                    <span class="risk-level__gauge"></span>
                </div>
            </div>
        </div>
        <!-- end of estimate content -->
        <!-- estimate actions -->
        <div class="growth-estimate__actions">
            <button type="submit" class="growth-estimate__see-plan" data-button="light">
                See your plan
                <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg>
            </button>
            <br />
            <a href="/" class="growth-estimate__back back-link">
                <svg role="img" class="icon--arrow-back.svg"><use xlink:href="#arrow-back"></use></svg> Back
            </a>
        </div>
        <!-- end of estimate actions -->
    </div>
    <div class="growth-estimate__disclaimer">
