...
<div class="heading--wide">
    <div class="grid">
        <h1 data-heading="h1">Your MoneyBuddy Plan Comparison</h1>
    </div>
</div>
<!-- end of heading -->
    ...
    <div class="grid">
        <div class="plan-breakdown">
            <div class="plan-breakdown__label">
                ...
                <div class="your-plan__val"><s:property  value="predictedValue" /></div>
            </div>
                </div>
            </div>
            <div class="plan-breakdown__content">
                <img src="displayChart?riskCategory=<s:property  value="riskCategory" />"/>
                
                            
            </div>
                <h2>Continue with my choice</h2>
            <div class="plan-actions">
            <a href="panCardVerification.jsp" class="plan-actions__apply" data-button="bright arrow">
                <span>
                    Continue <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg>
                </span>
            </a>
            <a href="SanityCheck.jsp" class="back-link">
        ...
        <div class="plan-breakdown">
            <div class="plan-breakdown__label">
                ...
                <div class="your-plan__val"><s:property  value="predictedSuggestedValue" /></div>
            </div>
                </div>
            </div>
            <div class="plan-breakdown__content">
                <img src="displayChart?riskCategory=<s:property  value="suggestedRiskCategory" />"  />
                             
            </div>
                <h2>Continue with suggested choice </h2>
                <div class="plan-actions">
            <a href="panCardVerification.jsp" class="plan-actions__apply" data-button="bright arrow">
                <span>
                    Continue <svg role="img" class="icon--arrow-small"><use xlink:href="#arrow-small"></use></svg>
