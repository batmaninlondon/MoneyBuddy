...
<!--========== HEADER ==========-->
    ...
    <div id="myDiv1" class="g-bg-color--white  ">
			<div id="myDiv2" class="row  MediumRisk g-container--md  ">
					...
					<div id="myDiv3" class="col-md-4   g-bg-color--white">
						...
						<s:set var="selectedFundId" value="#fundDetailsDataModelElement.fundId" />
						 <figure class="snip1418" onClick="buyFundHandler(<s:property value="selectedFundId" />);" >
	  					...
	  					<%-- <figcaption>
	    					<article class="s-promo-block-v6 g-bg-position--center swiper-slide" style="height:400px">
                        <div class="g-text-center--xs g-padding-x-15--xs g-padding-x-30--lg g-padding-y-50--xs g-margin-t-10--xs">
                            <div class="g-margin-b-25--xs">
                                <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs"><s:property value="#fundDetailsDataModelElement.fundName"/></h3>
                                <h3 class="g-font-size-16--xs g-color--white g-margin-b-5--xs"><s:property value="#fundDetailsDataModelElement.sector"/>. <s:property value="#fundDetailsDataModelElement.subSector"/></h3>
                                <p class="g-color--white">Start Date : <s:property value="#fundDetailsDataModelElement.fundStartDate"/></p>                       
					       		<p class="g-color--white">>Rating : <s:property value="#fundDetailsDataModelElement.rating"/></p>
					       		<p class="g-color--white">Risk : <s:property value="#fundDetailsDataModelElement.risk"/></p>
					        	<p class="g-color--white">3 yrs returns ss: <s:property value="#fundDetailsDataModelElement.returnsThreeYears"/>%</p>
					        	<p class="g-color--white">Minimum SIP Amount : <s:property value="#fundDetailsDataModelElement.minSipAmount"/>INR </p>
					        	<p class="g-color--white">Minimum SIP time : <s:property value="#fundDetailsDataModelElement.minSipYears"/> years</p>
					       		<p class="g-color--white">Minimum One time Amount : <s:property value="#fundDetailsDataModelElement.minLumsumAmount"/> INR</p>
                            </div>
