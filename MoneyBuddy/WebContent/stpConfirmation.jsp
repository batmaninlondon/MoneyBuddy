      			...
      			<div id="upfrontInvestmentDetails">
	        		...
	        		<div class="name g-margin-t-40--xs">
						...
						<div class="row g-margin-t-50--xs g-margin-b-50--xs">
								...
								<input id="stp-amount-range" type="range" min="0" max="<s:property value="stpAmount"/>" step="100"
												 value="100" onchange="showStpAmountPerMonth(this.value)"/>
								</div>
								<p class="title g-margin-l-100--md g-margin-l-20--xs  " >Rs. <span id="stpPerMonth" class="g-color--black">100</span></p>
