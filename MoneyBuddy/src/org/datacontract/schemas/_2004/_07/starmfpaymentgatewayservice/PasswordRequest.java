...
public class PasswordRequest {
    ...
    @XmlElementRef(name = "MemberId", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> memberId;
    @XmlElementRef(name = "PassKey", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> passKey;
    @XmlElementRef(name = "Password", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "UserId", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
