...
public class Response {
    ...
    @XmlElementRef(name = "Filler", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler;
    @XmlElementRef(name = "ResponseString", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> responseString;
    @XmlElementRef(name = "Status", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class, required = false)
