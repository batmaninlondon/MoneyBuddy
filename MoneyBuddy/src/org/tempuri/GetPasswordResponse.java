...
public class GetPasswordResponse {
    ...
    @XmlElementRef(name = "GetPasswordResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Response> getPasswordResult;
     ...
     *     
     */
    public JAXBElement<Response> getGetPasswordResult() {
     ...
     *     
     */
    public void setGetPasswordResult(JAXBElement<Response> value) {
