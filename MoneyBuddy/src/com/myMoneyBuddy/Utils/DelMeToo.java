...
public class DelMeToo  {
	...
	public static void main(String args[])  {
		...
		try {
			String mandateRes = trading.mandateStatus("204", "BSE000000501003");
			System.out.println("mandateRes : "+mandateRes);
...
/*		CommonUtil commonUtil = new CommonUtil();
    	Map<Date,Date> stpDateAndDuration = commonUtil.getStpDates("15", "99");
