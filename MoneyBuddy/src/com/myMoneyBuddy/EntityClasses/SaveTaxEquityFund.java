 ...
 */
@Entity
@Table (name="SAVE_TAX_EQUITY_FUND")
public class SaveTaxEquityFund {
    ...
    public SaveTaxEquityFund() {

    }

    public SaveTaxEquityFund(String riskCategory, String equityFundName,String equityFundInterestRate,String equityFundPercentage)  {
    ...
    public boolean equals(Object obj) {
        ...
        final SaveTaxEquityFund other = (SaveTaxEquityFund) obj;
