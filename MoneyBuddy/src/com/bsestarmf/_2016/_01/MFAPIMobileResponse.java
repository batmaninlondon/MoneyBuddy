...
@XmlRootElement(name = "MFAPIMobileResponse")
public class MFAPIMobileResponse {

    @XmlElementRef(name = "MFAPIMobileResult", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class, required = false)
    protected JAXBElement<Response> mfapiMobileResult;
     ...
     *     
     */
    public JAXBElement<Response> getMFAPIMobileResult() {
     ...
     *     
     */
    public void setMFAPIMobileResult(JAXBElement<Response> value) {
